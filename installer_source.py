...
_FILES: Dict[str, str] = {
    "InfoScraper.exe": "__INFO_SCRAPER_EXE__",
    "README.md": "__README_MD__",
    "USER_GUIDE.md": "__USER_GUIDE_MD__",
}
...
def main():
    ...
    for filename, b64data in _FILES.items():
        if b64data.startswith("__") and b64data.endswith("__"):
            # 占位符，未实际打包
            continue
